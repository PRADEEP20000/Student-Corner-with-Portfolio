<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignUpTS.aspx.cs" Inherits="SignUpTS" %>
...
<body>
  ...
  <!-- <input type="text" name="search" placeholder="Search..">-->
    ...
    <div class="container">
    <h1 style="margin-top:75px;"> Teachers Register</h1>
    ...
    <hr>
     ...
     &nbsp;<asp:TextBox ID="txtemail" placeholder="Enter Email" required="" runat="server"></asp:TextBox>

    <label for="Phone_no"><b>Phone No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
